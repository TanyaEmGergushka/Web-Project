	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (exists) {
				...
				// ProductDao.getInstance().getAllProducts(); //TreeSet -
				// orderBy
		...
		//
		// response.setContentType("text/html; charset=UTF-8"); // informing the
		// client that which format of data/response will be send
		...
		// !pass.isEmpty() || mail != null || !mail.isEmpty()) {
		// // login
		// request.getSession().setAttribute("logged", true); // при успешен
		// лог-ин
		// // това се записва в
		// // сесията и го има,
		// // докато тя е жива
